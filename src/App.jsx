...
const NotFound = () => {
  ...
  <div style={{ textAlign: "center", padding: "80px 24px" }}>
    <div style={{ fontSize: 46, fontWeight: 800, color: "var(--fw-blue)", marginBottom: 8 }}>404</div>
    <div style={{ fontSize: 20, fontWeight: 700, color: "var(--fw-text)", marginBottom: 8 }}>{tr("nf.title")}</div>
    <div style={{ fontSize: 14, color: "var(--fw-text-3)", marginBottom: 24 }}>
      {tr("nf.note")}
    </div>
    <Link to="/" style={{ display: "inline-block", padding: "12px 26px", background: "var(--fw-blue)", color: "#fff", borderRadius: 10, fontSize: 14, fontWeight: 700, textDecoration: "none" }}>
      {tr("common.goHome")}
    </Link>
  </div>
  );
