export const mockCars = [
  {
    ...
    lat: -34.5885, lng: -58.4315,
    description: "Auto en excelente estado, muy económico. Nunca tuve incidentes.",
    photos: [], seats: 5, transmission: "Automático", fuel: "Nafta",
    owner_id: "2", owner_name: "Roberto O.",
    rating: 4.8, reviews_count: 12,
    is_verified: true, approved: true, available: true,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    lat: -34.4731, lng: -58.5270,
    description: "Económico y fácil de estacionar. Ideal para la ciudad.",
    photos: [], seats: 5, transmission: "Manual", fuel: "Nafta",
    owner_id: "3", owner_name: "Carmen V.",
    rating: 4.3, reviews_count: 5,
    is_verified: true, approved: true, available: true,
  },
];
