...
const s = {
  ...
  success: { background:"#f0fdf4", border:"1.5px solid #bbf7d0", borderRadius:8, padding:"12px 16px", color:"#166534", fontSize:14, marginBottom:16, lineHeight:1.6 },
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <div style={s.back}>
          <Link to="/login" style={{ color:"#1a4d2e", fontWeight:600, fontSize:13 }}>
